...
<head>
    ...
    <div id="nuevoB">
        <div class="container-table">
            <form action="Tabla.php" method="POST" class="form_search">
                <input type="text" name="busqueda" placeholder="Buscar" value="<?php echo $_POST["busqueda"] ?>">
                <input type="submit" value="Buscar" class="btn_search">
            </form>
            <div class="table_title">Tabla contactos <a href="Editar.php" class="title_edit">Editar</a></div>
